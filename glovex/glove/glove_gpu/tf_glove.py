...
class GloveTF():
    def __init__(self, embedding_size, n_words, context_size=-1, max_vocab_size=100000, min_occurrences=1,
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000,
              tsne_epoch_interval=None, coo_mtx=None):
        self.__build_graph()
        ...
        batches = self.__prepare_batches(coo_mtx)
        total_steps = 0
    ...
    def __prepare_batches(self, coo_mtx=None):
        ...
        if coo_mtx is None:
            ...
            i_indices, j_indices, counts = coo_mtx.row, coo_mtx.col, coo_mtx.data
